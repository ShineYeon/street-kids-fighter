...
model_dir = 'ai/checkpoints'
config_path = 'ai/config/newConfig.config'
eval_prefix = 'valid'
...
def evaluate():
  ...
  evaluator = single_task_evaluator.SingleTaskEvaluator(
      dataset, model=model_, metrics=metrics_, output_dir=output_dir)
  ...
  controller = orbit.Controller(
      ...
      checkpoint_manager=tf.train.CheckpointManager(
          ...
          directory=model_dir,
          max_to_keep=5),
      eval_summary_dir=os.path.join(model_dir, eval_prefix),
