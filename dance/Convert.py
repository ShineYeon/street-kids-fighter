...
def getArg():
    ...
    parser.add_argument('--input_pkl_base', type=str, required=True) ## input_here (디렉토리)
    parser.add_argument('--fbx_source_path', type=str, required=True) ## fbx_here/fbx파일 (파일)
    parser.add_argument('--output_base', type=str, required=True) ## output_here (디렉토리)
